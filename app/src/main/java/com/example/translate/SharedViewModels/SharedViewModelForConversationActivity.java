...
public class SharedViewModelForConversationActivity extends AndroidViewModel {
    private static final String PREFERENCES_FILE = "com.example.translate_preferences";
    private static final String KEY_TRANSLATE_TO_LANGUAGE = "translate_to_language_conversation";
    private static final String KEY_TRANSLATE_FROM_LANGUAGE = "translate_from_language_conversation";
    ...
    public SharedViewModelForConversationActivity(Application application) {
        super(application);
