...
public class SharedViewModelForTextTranslateActivity extends AndroidViewModel {
    private static final String PREFERENCES_FILE = "com.example.translate_preferences";
    private static final String KEY_TRANSLATE_TO_LANGUAGE = "translate_to_language_text";
    private static final String KEY_TRANSLATE_FROM_LANGUAGE = "translate_from_language_text";
    ...
    public SharedViewModelForTextTranslateActivity(Application application) {
        super(application);
